...
def GenerateRandom01Arr(groups = 5, N = 10000, seed=0, func='mt19937'):
    seedlist = PrimeLessThanN(500000)
...
if __name__=="__main__":
    ...
    for rngtype in rngtypes:
        ...
        """
        chisq,pvalue = ChiSquare(datalist)
        print('chisq')
        print(chisq)
        print(pvalue)
        chisq,pvalue = KSTest(datalist)
        print('kstest')
        print(chisq)
        print(pvalue)
        chisq,pvalue = Serial2DTest(datalist)
        print('serial 2d test')
        print(chisq)
        print(pvalue)
        kldis = kldistance(datalist)
        print('kl dis')
        print(kldis)
        Echisq,pvalue = MonobitTest(datalist)
        print('monobit')
        print(Echisq)
        print(pvalue)
        """
        Echisq,pvalue = BlockFrequency(datalist)
        print(Echisq)
        print(pvalue)
